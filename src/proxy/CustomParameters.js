/** @typedef {import('../types').IOAuth2AuthorizationRequestCustomData} IOAuth2AuthorizationRequestCustomData */
/** @typedef {import('../types').IOAuth2CustomData} IOAuth2CustomData */
 ...
 * @param {IOAuth2AuthorizationRequestCustomData} data `customData.[type]` property from the settings object. The type is either `auth` or `token`.
 * @returns {void}
 */
 ...
 * @param {IOAuth2CustomData} data Value of settings' `customData` property
